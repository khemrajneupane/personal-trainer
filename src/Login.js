    ...
    render() {
        return (
            ...
            <h2 style = {{width : "100%"}}>Personal-Trainer Database</h2>
                <form className = "card" style = {{marginTop:"100px", border: "5px solid green", borderTopRightRadius: "50px"}}>
                    <div className="form-group">
           
                        <input style = {{borderTopRightRadius: "50px"}} value={this.state.email} onChange={this.handleChange} type="email" name="email" className="form-control"  placeholder="Enter email" />
